...
class IntegratedVerificationService:
    ...
    def __init__(self, db_session: Session, textverified_client: TextVerifiedClient = None,
        ...
        self.routing_engine = SmartRoutingEngine(twilio_client) if twilio_client else None
    ...
    def _load_supported_services(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "whatsapp": {
                ...
                "code_patterns": [r'WhatsApp[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*WhatsApp'],
            ...
            "telegram": {
                ...
                "code_patterns": [r'Telegram[:\s]*(\d{5})', r'(\d{5})\s*is\s*your\s*Telegram'],
            ...
            "discord": {
                ...
                "category": "gaming",
                "typical_code_length": 6,
                "code_patterns": [r'Discord[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*Discord'],
            ...
            "facebook": {
                ...
                "code_patterns": [r'Facebook[:\s]*(\d{5,8})', r'(\d{5,8})\s*is\s*your\s*Facebook'],
            ...
            "instagram": {
                ...
                "category": "social",
                "typical_code_length": 6,
                "code_patterns": [r'Instagram[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*Instagram'],
            ...
            "twitter": {
                ...
                "category": "social",
                "typical_code_length": 6,
                "code_patterns": [r'Twitter[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*Twitter'],
            ...
            "tiktok": {
                ...
                "category": "social",
                "typical_code_length": 6,
                "code_patterns": [r'TikTok[:\s]*(\d{4,6})', r'(\d{4,6})\s*is\s*your\s*TikTok'],
            ...
            "amazon": {
                ...
                "category": "ecommerce",
                "typical_code_length": 6,
                "code_patterns": [r'Amazon[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*Amazon'],
            ...
            "microsoft": {
                ...
                "code_patterns": [r'Microsoft[:\s]*(\d{7})', r'(\d{7})\s*is\s*your\s*Microsoft'],
                "average_delivery_time": 20,
                "success_rate": 0.96,
                "cost_tier": "standard"
            },
            "apple": {
                ...
                "category": "tech",
                "typical_code_length": 6,
                "code_patterns": [r'Apple[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*Apple'],
                "average_delivery_time": 25,
                "success_rate": 0.98,
                "cost_tier": "standard"
            },
            ...
            "airbnb": {
                ...
                "category": "travel",
                "typical_code_length": 6,
                "code_patterns": [r'Airbnb[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*Airbnb'],
                "average_delivery_time": 45,
                "success_rate": 0.90,
                "cost_tier": "premium"
            },
            "paypal": {
                ...
                "category": "finance",
                "typical_code_length": 6,
                "code_patterns": [r'PayPal[:\s]*(\d{6})', r'(\d{6})\s*is\s*your\s*PayPal'],
                "average_delivery_time": 30,
                "success_rate": 0.95,
                "cost_tier": "standard"
            },
            "coinbase": {
                ...
                "category": "crypto",
                "typical_code_length": 7,
                "code_patterns": [r'Coinbase[:\s]*(\d{7})', r'(\d{7})\s*is\s*your\s*Coinbase'],
                "average_delivery_time": 40,
                "success_rate": 0.93,
                "cost_tier": "premium"
            }
    ...
    async def create_service_verification(self, user_id: str, service_name: str, 
                                        capability: str = "sms", 
                                        preferred_country: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.routing_engine and phone_number:
                try:
                    ...
                    routing_recommendation = await self.routing_engine.suggest_optimal_numbers(
            ...
            asyncio.create_task(self._enhanced_verification_monitoring(
                verification.id, service_config
            ))
            ...
            workflow_info = {
                ...
                "routing_recommendation": routing_recommendation.primary_option.__dict__ if routing_recommendation else None,
                "instructions": self._generate_verification_instructions(service_name, phone_number),
                "monitoring": {
            ...
            logger.info(f"Created service verification workflow for {service_name} (ID: {verification.id})")
    ...
    async def get_verification_status(self, user_id: str, verification_id: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            status_details = self._get_status_details(verification, elapsed_time, expected_time)
            
            status_info = {
                "verification_id": verification_id,
                "service_name": verification.service_name,
                "service_display_name": service_config.get("name", verification.service_name),
    ...
    async def cancel_verification(self, user_id: str, verification_id: str, 
        ...
        try:
            ...
            if success:
                ...
                logger.info(f"Verification {verification_id} cancelled by user {user_id}: {reason}")
    ...
    async def get_user_verification_history(self, user_id: str, 
        ...
        try:
            ...
            if include_analytics:
                analytics = await self._generate_verification_analytics(user_id, verifications)
    ...
    def _generate_verification_instructions(self, service_name: str, phone_number: str) -> Dict[str, Any]:
        """
    ...
    def _get_status_details(self, verification: VerificationRequest, 
                          elapsed_time: float, expected_time: float) -> Dict[str, str]:
        """
    ...
    async def _enhanced_verification_monitoring(self, verification_id: str, 
        ...
        """
        try:
            max_wait_time = service_config.get("average_delivery_time", 60) * 3  # 3x expected time
            check_interval = min(15, service_config.get("average_delivery_time", 60) // 4)  # Check 4 times during expected period
                ...
                try:
                    ...
                    if messages and not verification.verification_code:
                        ...
                        if all_codes:
                            ...
                            logger.info(f"Enhanced monitoring completed verification {verification_id} with code {verification.verification_code}")
                            break
                
                except Exception as e:
                    logger.warning(f"Error in enhanced monitoring for {verification_id}: {e}")
            ...
            if verification and verification.status == 'pending':
                ...
                logger.info(f"Enhanced monitoring expired verification {verification_id}")
        
        except Exception as e:
            logger.error(f"Error in enhanced verification monitoring: {e}")
    
    async def _generate_verification_analytics(self, user_id: str, 
                                             verifications: List[VerificationRequest]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for service in service_success_rates:
                ...
                service_success_rates[service]["rate"] = (completed / total) * 100 if total > 0 else 0
            ...
            analytics = {
                ...
                "recent_activity": {
                    ...
                    "recent_success_rate": round(
                        (len([v for v in recent_verifications if v.status == "completed"]) / 
                         len(recent_verifications) * 100) if recent_verifications else 0, 2
                    )
                },
    ...
    def _generate_user_recommendations(self, service_usage: Dict[str, int], 
        ...
        if not recommendations:
            recommendations.append("Your verification performance is good! Keep using the platform as usual.")
        
        return recommendations


# Factory function
def create_integrated_verification_service(db_session: Session, 
                                         textverified_client: TextVerifiedClient = None,
                                         twilio_client: EnhancedTwilioClient = None) -> IntegratedVerificationService:
    """
    ...
    """
    try:
        return IntegratedVerificationService(db_session, textverified_client, twilio_client)
    except Exception as e:
