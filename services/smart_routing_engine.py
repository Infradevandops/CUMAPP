...
class SmartRoutingEngine:
    ...
    def _load_country_data(self) -> Dict[str, CountryInfo]:
        ...
        countries = {
            "US": CountryInfo("US", "United States", "North America", 39.8283, -98.5795, "+1", "USD", -5.0),
            "CA": CountryInfo("CA", "Canada", "North America", 56.1304, -106.3468, "+1", "CAD", -5.0),
            "GB": CountryInfo("GB", "United Kingdom", "Europe", 55.3781, -3.4360, "+44", "GBP", 0.0),
            "DE": CountryInfo("DE", "Germany", "Europe", 51.1657, 10.4515, "+49", "EUR", 1.0),
            "FR": CountryInfo("FR", "France", "Europe", 46.2276, 2.2137, "+33", "EUR", 1.0),
            "IT": CountryInfo("IT", "Italy", "Europe", 41.8719, 12.5674, "+39", "EUR", 1.0),
            "ES": CountryInfo("ES", "Spain", "Europe", 40.4637, -3.7492, "+34", "EUR", 1.0),
            "NL": CountryInfo("NL", "Netherlands", "Europe", 52.1326, 5.2913, "+31", "EUR", 1.0),
            "AU": CountryInfo("AU", "Australia", "Oceania", -25.2744, 133.7751, "+61", "AUD", 10.0),
            "JP": CountryInfo("JP", "Japan", "Asia", 36.2048, 138.2529, "+81", "JPY", 9.0),
            "CN": CountryInfo("CN", "China", "Asia", 35.8617, 104.1954, "+86", "CNY", 8.0),
            "IN": CountryInfo("IN", "India", "Asia", 20.5937, 78.9629, "+91", "INR", 5.5),
            "BR": CountryInfo("BR", "Brazil", "South America", -14.2350, -51.9253, "+55", "BRL", -3.0),
            "MX": CountryInfo("MX", "Mexico", "North America", 23.6345, -102.5528, "+52", "MXN", -6.0),
            "AR": CountryInfo("AR", "Argentina", "South America", -38.4161, -63.6167, "+54", "ARS", -3.0),
            "ZA": CountryInfo("ZA", "South Africa", "Africa", -30.5595, 22.9375, "+27", "ZAR", 2.0),
            "NG": CountryInfo("NG", "Nigeria", "Africa", 9.0820, 8.6753, "+234", "NGN", 1.0),
            "EG": CountryInfo("EG", "Egypt", "Africa", 26.8206, 30.8025, "+20", "EGP", 2.0),
            "RU": CountryInfo("RU", "Russia", "Europe/Asia", 61.5240, 105.3188, "+7", "RUB", 3.0),
            "KR": CountryInfo("KR", "South Korea", "Asia", 35.9078, 127.7669, "+82", "KRW", 9.0),
            "SG": CountryInfo("SG", "Singapore", "Asia", 1.3521, 103.8198, "+65", "SGD", 8.0),
            "HK": CountryInfo("HK", "Hong Kong", "Asia", 22.3193, 114.1694, "+852", "HKD", 8.0),
            "TH": CountryInfo("TH", "Thailand", "Asia", 15.8700, 100.9925, "+66", "THB", 7.0),
            "MY": CountryInfo("MY", "Malaysia", "Asia", 4.2105, 101.9758, "+60", "MYR", 8.0),
            "ID": CountryInfo("ID", "Indonesia", "Asia", -0.7893, 113.9213, "+62", "IDR", 7.0),
            "PH": CountryInfo("PH", "Philippines", "Asia", 12.8797, 121.7740, "+63", "PHP", 8.0),
            "VN": CountryInfo("VN", "Vietnam", "Asia", 14.0583, 108.2772, "+84", "VND", 7.0),
            "TR": CountryInfo("TR", "Turkey", "Europe/Asia", 38.9637, 35.2433, "+90", "TRY", 3.0),
            "SA": CountryInfo("SA", "Saudi Arabia", "Asia", 23.8859, 45.0792, "+966", "SAR", 3.0),
            "AE": CountryInfo("AE", "United Arab Emirates", "Asia", 23.4241, 53.8478, "+971", "AED", 4.0),
            "IL": CountryInfo("IL", "Israel", "Asia", 31.0461, 34.8516, "+972", "ILS", 2.0),
            "SE": CountryInfo("SE", "Sweden", "Europe", 60.1282, 18.6435, "+46", "SEK", 1.0),
            "NO": CountryInfo("NO", "Norway", "Europe", 60.4720, 8.4689, "+47", "NOK", 1.0),
            "DK": CountryInfo("DK", "Denmark", "Europe", 56.2639, 9.5018, "+45", "DKK", 1.0),
            "FI": CountryInfo("FI", "Finland", "Europe", 61.9241, 25.7482, "+358", "EUR", 2.0),
            "CH": CountryInfo("CH", "Switzerland", "Europe", 46.8182, 8.2275, "+41", "CHF", 1.0),
            "AT": CountryInfo("AT", "Austria", "Europe", 47.5162, 14.5501, "+43", "EUR", 1.0),
            "BE": CountryInfo("BE", "Belgium", "Europe", 50.5039, 4.4699, "+32", "EUR", 1.0),
            "PT": CountryInfo("PT", "Portugal", "Europe", 39.3999, -8.2245, "+351", "EUR", 0.0),
            "IE": CountryInfo("IE", "Ireland", "Europe", 53.4129, -8.2439, "+353", "EUR", 0.0),
            "PL": CountryInfo("PL", "Poland", "Europe", 51.9194, 19.1451, "+48", "PLN", 1.0),
            "CZ": CountryInfo("CZ", "Czech Republic", "Europe", 49.8175, 15.4730, "+420", "CZK", 1.0),
            "HU": CountryInfo("HU", "Hungary", "Europe", 47.1625, 19.5033, "+36", "HUF", 1.0),
            "RO": CountryInfo("RO", "Romania", "Europe", 45.9432, 24.9668, "+40", "RON", 2.0),
            "BG": CountryInfo("BG", "Bulgaria", "Europe", 42.7339, 25.4858, "+359", "BGN", 2.0),
            "GR": CountryInfo("GR", "Greece", "Europe", 39.0742, 21.8243, "+30", "EUR", 2.0),
            "HR": CountryInfo("HR", "Croatia", "Europe", 45.1000, 15.2000, "+385", "HRK", 1.0),
            "SI": CountryInfo("SI", "Slovenia", "Europe", 46.1512, 14.9955, "+386", "EUR", 1.0),
            "SK": CountryInfo("SK", "Slovakia", "Europe", 48.6690, 19.6990, "+421", "EUR", 1.0),
            "LT": CountryInfo("LT", "Lithuania", "Europe", 55.1694, 23.8813, "+370", "EUR", 2.0),
            "LV": CountryInfo("LV", "Latvia", "Europe", 56.8796, 24.6032, "+371", "EUR", 2.0),
            "EE": CountryInfo("EE", "Estonia", "Europe", 58.5953, 25.0136, "+372", "EUR", 2.0),
        }
    ...
    def get_closest_countries(self, target_country: str, limit: int = 5) -> List[Tuple[str, float]]:
        """
    ...
    def calculate_delivery_score(self, from_country: str, to_country: str) -> float:
        ...
        if (from_country in self.country_data and to_country in self.country_data):
            if self.country_data[from_country].continent == self.country_data[to_country].continent:
                continent_bonus = 0.1
    ...
    def calculate_cost_comparison(self, from_country: str, to_country: str, 
                                message_count: int = 1, call_minutes: int = 0) -> Dict[str, float]:
        """
        ...
        """
        if (from_country not in self.cost_matrix or 
            to_country not in self.cost_matrix[from_country]):
    ...
    async def suggest_optimal_numbers(self, destination_number: str, 
                                    user_numbers: List[str] = None,
                                    message_count: int = 1,
                                    call_minutes: int = 0) -> RoutingRecommendation:
        """
        ...
        try:
            ...
            if not dest_country:
                raise ValueError(f"Could not determine country for {destination_number}")
                ...
                for number in user_numbers:
                    ...
                    if from_country:
                        option = await self._evaluate_number_option(
                            number, from_country, dest_country, 
                            message_count, call_minutes, is_owned=True
                        )
                        if option:
            ...
            worst_cost = max(opt.monthly_cost + (opt.sms_cost * message_count) + 
                           (opt.voice_cost * call_minutes) for opt in options)
            best_cost = (primary_option.monthly_cost + 
    ...
    async def _evaluate_number_option(self, phone_number: str, from_country: str, 
                                    to_country: str, message_count: int, 
                                    call_minutes: int, is_owned: bool = False) -> Optional[NumberOption]:
        """
        ...
        try:
            ...
            cost_score = max(0, 1 - (cost_info["per_sms"] / 0.10))  # Normalize to $0.10 max
            distance_score = max(0, 1 - (distance / 20000))  # Normalize to 20,000km max
            ownership_bonus = 0.2 if is_owned else 0.0
            
            total_score = (delivery_score * 0.4 + 
                          cost_score * 0.3 + 
                          distance_score * 0.2 + 
                          ownership_bonus * 0.1)
            
            country_name = self.country_data.get(from_country, CountryInfo("", "", "", 0, 0, "", "", 0)).name
    ...
    async def _create_hypothetical_option(self, from_country: str, to_country: str,
                                        message_count: int, call_minutes: int) -> Optional[NumberOption]:
        """
        ...
        try:
            ...
            return await self._evaluate_number_option(
                sample_number, from_country, to_country, 
                message_count, call_minutes, is_owned=False
            )
    ...
    def _generate_recommendation_reason(self, option: NumberOption, dest_country: str,
                                      cost_savings: float, delivery_improvement: float) -> str:
        """
    ...
    async def get_routing_analytics(self, user_numbers: List[str], 
                                  recent_destinations: List[str]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for dest_country, frequency in destination_countries.items():
                if dest_country not in analytics["countries_covered"] and frequency >= 3:
                    # Suggest getting a local number for frequently contacted countries
                    country_name = self.country_data.get(dest_country, CountryInfo("", "", "", 0, 0, "", "", 0)).name
                    analytics["optimization_opportunities"].append({
                        "type": "local_number_suggestion",
                        "country": dest_country,
                        "country_name": country_name,
                        "frequency": frequency,
                        "potential_savings": frequency * 0.04,  # Estimated savings per message
            ...
            analytics["destination_countries"] = list(analytics["destination_countries"])
...
# Factory function
def create_smart_routing_engine(twilio_client: EnhancedTwilioClient = None) -> SmartRoutingEngine:
    """
