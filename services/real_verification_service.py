...
class RealVerificationService:
    ...
    async def get_available_numbers(self, country: str = "US", service: str = "whatsapp") -> List[Dict]:
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    logger.warning(f"TextVerified verification error: {response.status_code}")
                    return self._mock_verification(service)
            ...
            async with httpx.AsyncClient() as client:
                ...
                if response.status_code == 200:
                    ...
                    if verification_id in self.active_verifications:
                        self.active_verifications[verification_id]["messages"] = messages
    ...
    def _mock_numbers(self) -> List[Dict]:
        ...
        return [
            {"id": 1, "number": "+1234567890", "country": "US", "cost": 0.50, "services": ["whatsapp", "google"]},
            {"id": 2, "number": "+1234567891", "country": "US", "cost": 0.45, "services": ["telegram", "facebook"]},
            {"id": 3, "number": "+4412345678", "country": "UK", "cost": 0.60, "services": ["whatsapp", "google"]},
        ]
