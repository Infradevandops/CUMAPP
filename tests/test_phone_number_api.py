...
class TestPhoneNumberAPI:
    ...
    def test_get_available_numbers_success(self, client, mock_user):
        ...
        with patch(
            "services.auth_service.get_current_active_user", return_value=mock_user
        ):
            with patch(
                "services.phone_number_service.PhoneNumberService.search_available_numbers"
            ) as mock_search:
    ...
    def test_purchase_phone_number_success(self, client, mock_user, mock_phone_number):
        ...
        with patch(
            ...
            with patch(
                "services.phone_number_service.PhoneNumberService.purchase_phone_number"
            ) as mock_purchase:
                ...
                purchase_data = {"phone_number": "+15551234567", "auto_renew": True}
    ...
    def test_get_owned_numbers_success(self, client, mock_user, mock_phone_number):
        ...
        with patch(
            ...
            with patch(
                "services.phone_number_service.PhoneNumberService.get_owned_numbers"
            ) as mock_owned:
    ...
    def test_renew_phone_number_success(self, client, mock_user, mock_phone_number):
        ...
        with patch(
            ...
            with patch(
                "services.phone_number_service.PhoneNumberService.renew_phone_number"
            ) as mock_renew:
                ...
                renewal_data = {"renewal_months": 2, "auto_renew": True}
    ...
    def test_renew_phone_number_not_found(self, client, mock_user):
        ...
        with patch(
            ...
            with patch(
                ...
                mock_renew.side_effect = ValueError(
                    "Phone number not found or not owned by user"
                )

                renewal_data = {"renewal_months": 1}

                response = client.put(
                    "/api/numbers/nonexistent/renew", json=renewal_data
                )
    ...
    def test_cancel_phone_number_success(self, client, mock_user):
        ...
        with patch(
            ...
            with patch(
                "services.phone_number_service.PhoneNumberService.cancel_phone_number"
            ) as mock_cancel:
        ...
        with patch(
            ...
            with patch(
                ...
                mock_cancel.side_effect = ValueError(
                    "Phone number is already cancelled"
                )
    ...
    def test_get_phone_number_usage_success(self, client, mock_user):
        ...
        with patch(
            ...
            with patch(
                "services.phone_number_service.PhoneNumberService.get_usage_statistics"
            ) as mock_stats:
    ...
    def test_get_phone_number_usage_with_date_range(self, client, mock_user):
        ...
        with patch(
            ...
            with patch(
                ...
                response = client.get(
                    "/api/numbers/phone_1/usage?start_date=2024-01-01&end_date=2024-01-31"
                )
...
class TestPhoneNumberAPIValidation:
    ...
    def test_purchase_invalid_phone_number(self, client, mock_user):
        ...
        with patch(
            ...
            purchase_data = {"phone_number": "invalid_number", "auto_renew": True}
    ...
    def test_renew_invalid_months(self, client, mock_user):
        ...
        with patch(
            ...
            renewal_data = {"renewal_months": 0}  # Invalid: must be >= 1
