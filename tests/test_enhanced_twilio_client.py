...
class TestEnhancedTwilioClient:
    ...
    async def test_search_available_numbers(self, enhanced_client, mock_twilio_client):
        ...
        enhanced_client.client.available_phone_numbers.return_value.local.list.return_value = [mock_number]
    ...
    async def test_purchase_number(self, enhanced_client, mock_twilio_client):
        ...
        enhanced_client.client.incoming_phone_numbers.create.return_value = mock_purchased_number
    ...
    async def test_release_number(self, enhanced_client, mock_twilio_client):
        ...
        enhanced_client.client.incoming_phone_numbers.return_value.delete.return_value = True
        
        result = await enhanced_client.release_number("PN123456")
        
        assert result == True
        enhanced_client.client.incoming_phone_numbers.assert_called_once_with("PN123456")
    ...
    async def test_get_account_balance(self, enhanced_client, mock_twilio_client):
        ...
        enhanced_client.client.api.accounts.return_value.fetch.return_value = mock_account
...
class TestEnhancedTwilioClientFactory:
    ...
    def test_create_enhanced_twilio_client_exception(self):
        ...
        with patch('enhanced_twilio_client.EnhancedTwilioClient', side_effect=Exception("Test error")):
            result = create_enhanced_twilio_client("test_sid", "test_token")
            assert result is None
