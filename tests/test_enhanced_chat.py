...
class TestEnhancedChatInterface:
    ...
    def test_enhanced_chat_interface_endpoint(self, client, mock_user):
        ...
        with patch(
            ...
            with patch(
                "services.conversation_service.ConversationService.get_user_conversations",
                return_value=([], 0),
            ):
    ...
    def test_chat_settings_update(self, client, mock_user):
        ...
        settings_update = {
            "notifications": {"desktop_enabled": False, "sound_enabled": True},
            "chat_preferences": {"show_timestamps": True, "auto_scroll": False},
        }
...
class TestTypingIndicators:
    ...
    def test_typing_indicator_start(self, connection_manager):
        ...
        connection_manager.handle_typing_indicator.assert_called_once_with(
            typing_message
        )
