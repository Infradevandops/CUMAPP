...
class TestConversationEndpoints:
    ...
    def test_get_conversations(self, client, test_users, auth_headers, db_session):
        ...
        # Get conversations
        response = client.get("/api/conversations/", headers=auth_headers["user0"])
    ...
    def test_get_conversation_by_id(self, client, test_users, auth_headers, db_session):
        ...
        response = client.get(
            f"/api/conversations/{conversation_id}", headers=auth_headers["user0"]
        )
...
class TestMessageEndpoints:
    ...
    def test_send_message(self, client, test_users, auth_headers, db_session):
        ...
        create_response = client.post(
            "/api/conversations/",
            json={"title": "Message Test", "participant_ids": [test_users[1].id]},
            headers=auth_headers["user0"],
        )
        ...
        response = client.post(
            ...
            json={"content": "Hello, world!", "message_type": "CHAT"},
            headers=auth_headers["user0"],
        )
    ...
    def test_get_messages(self, client, test_users, auth_headers, db_session):
        ...
        create_response = client.post(
            "/api/conversations/",
            json={"title": "Get Messages Test", "participant_ids": [test_users[1].id]},
            headers=auth_headers["user0"],
        )
...
class TestUtilityEndpoints:
    ...
    def test_mark_messages_as_read(self, client, test_users, auth_headers, db_session):
        ...
        create_response = client.post(
            "/api/conversations/",
            json={"title": "Read Test", "participant_ids": [test_users[1].id]},
            headers=auth_headers["user0"],
        )
    ...
    def test_search_messages(self, client, test_users, auth_headers, db_session):
        ...
        create_response = client.post(
            "/api/conversations/",
            json={"title": "Search Test", "participant_ids": [test_users[1].id]},
            headers=auth_headers["user0"],
        )
...
class TestAuthenticationAndAuthorization:
    ...
    def test_access_other_user_conversation(
        ...
        response = client.get(
            f"/api/conversations/{conversation_id}", headers=auth_headers["user2"]
        )
...
class TestErrorHandling:
    ...
    def test_invalid_conversation_id(self, client, auth_headers):
        ...
        response = client.get(
            "/api/conversations/invalid-id", headers=auth_headers["user0"]
        )
