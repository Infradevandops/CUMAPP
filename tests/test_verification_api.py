...
class TestVerificationAPI:
    ...
    def test_create_verification_success(
        self, client, auth_headers, test_user, mock_textverified_client
    ):
        """Test successful verification creation"""
        request_data = {"service_name": "whatsapp", "capability": "sms"}

        response = client.post(
            "/api/verifications/create", json=request_data, headers=auth_headers
        )
        ...
        mock_textverified_client.create_verification.assert_called_once_with(
            service_name="whatsapp", capability="sms"
        )
    ...
    def test_create_verification_invalid_token(self, client):
        ...
        response = client.post(
            "/api/verifications/create", json=request_data, headers=headers
        )
    ...
    def test_get_verifications_with_data(
        self, client, auth_headers, test_user, db_session, mock_textverified_client
    ):
    ...
    def test_get_verifications_with_filters(
        ...
        response = client.get(
            "/api/verifications?service_name=whatsapp", headers=auth_headers
        )
        ...
        # Filter by status
        response = client.get(
            "/api/verifications?status=completed", headers=auth_headers
        )
    ...
    def test_get_verifications_with_search(
        self, client, auth_headers, test_user, db_session
    ):
        ...
        response = client.get(
            "/api/verifications?search=whatsapp", headers=auth_headers
        )
        ...
        response = client.get(
            "/api/verifications?search=1234567890", headers=auth_headers
        )
    ...
    def test_get_verifications_pagination(
        self, client, auth_headers, test_user, db_session
    ):
        ...
        # Test first page
        response = client.get(
            "/api/verifications?page=1&page_size=10", headers=auth_headers
        )
        ...
        # Test second page
        response = client.get(
            "/api/verifications?page=2&page_size=10", headers=auth_headers
        )
    ...
    def test_get_verification_by_id(self, client, auth_headers, test_user, db_session):
        ...
        response = client.get(
            f"/api/verifications/{verification.id}", headers=auth_headers
        )
    ...
    def test_get_verification_not_found(self, client, auth_headers, test_user):
        ...
        response = client.get("/api/verifications/invalid-id", headers=auth_headers)

        assert response.status_code == 404

    def test_get_verification_wrong_user(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    def test_get_verification_codes(
        self, client, auth_headers, test_user, db_session, mock_textverified_client
    ):
        ...
        response = client.get(
            f"/api/verifications/{verification.id}/codes", headers=auth_headers
        )
    ...
    def test_get_verification_phone(
        self, client, auth_headers, test_user, db_session, mock_textverified_client
    ):
        ...
        response = client.get(
            f"/api/verifications/{verification.id}/phone", headers=auth_headers
        )
        ...
        mock_textverified_client.get_verification_number.assert_called_once_with(
            "tv_123"
        )
    ...
    def test_delete_verification_not_found(self, client, auth_headers, test_user):
        ...
        response = client.delete("/api/verifications/invalid-id", headers=auth_headers)

        assert response.status_code == 404

    def test_delete_completed_verification(
        self, client, auth_headers, test_user, db_session
    ):
    ...
    def test_get_verification_statistics(
        ...
        response = client.get(
            "/api/verifications/stats/summary?period_days=30", headers=auth_headers
        )
    ...
    def test_export_verification_data_json(
        self, client, auth_headers, test_user, db_session
    ):
        ...
        response = client.get(
            "/api/verifications/export/data?format_type=json", headers=auth_headers
        )
    ...
    def test_export_verification_data_csv(
        self, client, auth_headers, test_user, db_session
    ):
        ...
        response = client.get(
            "/api/verifications/export/data?format_type=csv", headers=auth_headers
        )
...
class TestVerificationAPIValidation:
    ...
    def test_get_verifications_invalid_pagination(self, client, auth_headers):
        ...
        # Invalid page number
        response = client.get("/api/verifications?page=0", headers=auth_headers)

        assert response.status_code == 422

        # Invalid page size
        response = client.get("/api/verifications?page_size=0", headers=auth_headers)

        assert response.status_code == 422

        # Page size too large
        response = client.get("/api/verifications?page_size=1000", headers=auth_headers)
    ...
    def test_export_invalid_format(self, client, auth_headers):
        ...
        response = client.get(
            "/api/verifications/export/data?format_type=xml", headers=auth_headers
        )
    ...
    def test_statistics_invalid_period(self, client, auth_headers):
        ...
        # Period too small
        response = client.get(
            "/api/verifications/stats/summary?period_days=0", headers=auth_headers
        )
        ...
        # Period too large
        response = client.get(
            "/api/verifications/stats/summary?period_days=400", headers=auth_headers
        )
