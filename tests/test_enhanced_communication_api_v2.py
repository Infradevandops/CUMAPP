...
class TestEnhancedCommunicationAPIv2:
    ...
    def test_create_enhanced_conversation_success(self, mock_communication_service, mock_user):
        ...
        with patch("api.enhanced_communication_api_v2.get_current_user", return_value=mock_user), \
             patch("api.enhanced_communication_api_v2.get_communication_service", return_value=mock_communication_service):
    ...
    def test_get_conversation_with_ai_insights(self, mock_communication_service, mock_user):
        ...
        with patch("api.enhanced_communication_api_v2.get_current_user", return_value=mock_user), \
            ...
            response = client.get("/api/communication/v2/conversations/conv_123/ai-insights")
    ...
    def test_get_communication_analytics(self, mock_communication_service, mock_user):
        ...
        mock_communication_service.get_communication_analytics.return_value = {
            ...
            "ai_insights": {
                ...
                "sentiment_distribution": {"positive": 70, "neutral": 25, "negative": 5},
