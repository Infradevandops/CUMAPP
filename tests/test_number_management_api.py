...
class TestNumberManagementAPI:
    ...
    def test_search_available_numbers_success(self, mock_twilio_client, mock_user, sample_available_numbers):
        """Test successful number search"""
        mock_twilio_client.search_available_numbers.return_value = sample_available_numbers
        
        with patch('api.number_management_api.get_current_user', return_value=mock_user), \
             patch('api.number_management_api.get_twilio_client', return_value=mock_twilio_client):
            
            response = client.post("/api/numbers/search", json={
                "country_code": "US",
                "area_code": "234",
                "number_type": "local",
                "capabilities": ["sms", "voice"],
    ...
    def test_purchase_phone_number_success(self, mock_twilio_client, mock_user, sample_purchased_number):
        ...
        with patch('api.number_management_api.get_current_user', return_value=mock_user), \
            ...
            response = client.post("/api/numbers/purchase", json={
                "phone_number": "+1234567890",
                "friendly_name": "My Business Number",
                "auto_renew": True,
                "usage_plan": "standard",
    ...
    def test_get_owned_numbers_success(self, mock_twilio_client, mock_user, sample_purchased_number):
    ...
    def test_get_owned_numbers_with_filters(self, mock_twilio_client, mock_user):
        ...
        with patch('api.number_management_api.get_current_user', return_value=mock_user), \
            ...
            response = client.get("/api/numbers/owned?status_filter=active&country_filter=US")
    ...
    def test_update_phone_number_success(self, mock_twilio_client, mock_user, sample_purchased_number):
        ...
        with patch('api.number_management_api.get_current_user', return_value=mock_user), \
            ...
            response = client.put("/api/numbers/+1234567890", json={
    ...
    def test_get_number_usage_not_found(self, mock_twilio_client, mock_user):
        ...
        mock_twilio_client.get_number_usage_stats.side_effect = ValueError("Number not found")
    ...
    def test_calculate_cost_estimate_success(self, mock_routing_engine):
        ...
        with patch('api.number_management_api.get_routing_engine', return_value=mock_routing_engine):
            response = client.post("/api/numbers/cost-estimate", json={
                "from_country": "US",
                "to_country": "CA",
                "message_count": 1,
                "call_minutes": 60,
    ...
    def test_get_optimization_recommendations_success(self, mock_routing_engine, mock_user):
        ...
        with patch('api.number_management_api.get_current_user', return_value=mock_user), \
             patch('api.number_management_api.get_routing_engine', return_value=mock_routing_engine):
            
            response = client.post("/api/numbers/optimize", json={
    ...
    def test_get_number_analytics_success(self, mock_twilio_client, mock_user):
        ...
        analytics = {
            ...
            "cost_trends": {
                "last_6_months": [20.0, 22.0, 24.0, 25.0, 25.0, 25.0]
            },
            "recommendations": [
    ...
    def test_get_supported_countries_success(self, mock_twilio_client):
        ...
        with patch('api.number_management_api.get_twilio_client', return_value=mock_twilio_client):
    ...
    def test_service_unavailable_error(self, mock_user):
        ...
        with patch('api.number_management_api.get_current_user', return_value=mock_user), \
             patch('api.number_management_api.get_twilio_client', side_effect=Exception("Service unavailable")):
...
class TestNumberManagementAPIIntegration:
    ...
    def test_full_number_management_workflow(self):
        ...
        for expected_route in expected_routes:
            ...
            route_exists = any(expected_route.replace("{phone_number}", "test") in route 
