...
class TestAIAssistantService:
    ...
    @pytest.mark.asyncio
    async def test_add_message_to_context(self, ai_service, sample_conversation_context):
    ...
    async def test_generate_response_suggestions(self, ai_service):
        ...
        await ai_service.create_conversation_context(
            conversation_id=conversation_id,
            participants=["user_789", "assistant"]
        )
    ...
    @pytest.mark.asyncio
    async def test_enhance_conversation_auto_summary(self, ai_service, sample_conversation_context):
    ...
    @pytest.mark.asyncio
    async def test_enhance_conversation_sentiment_only(self, ai_service, sample_conversation_context):
        ...
        enhancements = await ai_service.enhance_conversation(
            conversation_id=conversation_id,
            enhancement_type="sentiment"
        )
        
        assert "sentiment" in enhancements
        assert "overall" in enhancements["sentiment"]
        assert "confidence" in enhancements["sentiment"]
        assert enhancements["sentiment"]["overall"] in ["positive", "negative", "neutral"]
    ...
    def test_get_template_suggestions_greeting(self, ai_service):
        ...
        suggestions = ai_service._get_template_suggestions(IntentType.GREETING, "Hello!")
    ...
    def test_get_template_suggestions_question(self, ai_service):
        ...
        suggestions = ai_service._get_template_suggestions(IntentType.QUESTION, "How does this work?")
    ...
    def test_determine_tone_helpful(self, ai_service):
        ...
        tone = ai_service._determine_tone("I'd be happy to help you", IntentType.REQUEST)
        assert tone == "helpful"
    
    def test_determine_tone_empathetic(self, ai_service):
        """Test tone determination for empathetic suggestions"""
        tone = ai_service._determine_tone("I understand your frustration", IntentType.COMPLAINT)
    ...
    def test_determine_tone_professional(self, ai_service):
        ...
        tone = ai_service._determine_tone("Here's the information you requested", IntentType.QUESTION)
    ...
    def test_generate_reasoning_greeting(self, ai_service):
        ...
        reasoning = ai_service._generate_reasoning("Hello! How can I help?", IntentType.GREETING)
    ...
    def test_generate_reasoning_request(self, ai_service):
        ...
        reasoning = ai_service._generate_reasoning("I'll help you with that", IntentType.REQUEST)
