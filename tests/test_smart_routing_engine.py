...
from services.smart_routing_engine import (
    SmartRoutingEngine, CountryInfo, NumberOption, RoutingRecommendation,
...
class TestSmartRoutingEngine:
    ...
    def test_calculate_cost_comparison_domestic(self, routing_engine):
        ...
        costs = routing_engine.calculate_cost_comparison("US", "US", message_count=10, call_minutes=5)
    ...
    def test_calculate_cost_comparison_international(self, routing_engine):
        ...
        domestic_costs = routing_engine.calculate_cost_comparison("US", "US", message_count=1)
        international_costs = routing_engine.calculate_cost_comparison("US", "GB", message_count=1)
    ...
    async def test_suggest_optimal_numbers_domestic_preference(self, routing_engine):
        ...
        assert (recommendation.primary_option.country_code == "GB" or
                recommendation.primary_option.phone_number == "+447700000001")
    ...
    async def test_get_routing_analytics_optimization_suggestions(self, routing_engine):
        ...
        french_numbers = ["+33600000001", "+33600000002", "+33600000003", "+33600000004"]
        ...
        french_suggestion = next((opp for opp in opportunities if opp["country"] == "FR"), None)
...
class TestSmartRoutingEngineFactory:
    ...
    def test_create_smart_routing_engine_exception(self):
        ...
        with patch('services.smart_routing_engine.SmartRoutingEngine', side_effect=Exception("Test error")):
