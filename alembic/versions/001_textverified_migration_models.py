...
def upgrade():
    ...
    op.create_table('user_numbers',
        ...
        sa.Column('routing_type', sa.Enum('DIRECT', 'LOCAL_NUMBER', 'REGIONAL_HUB', 'SMART_ROUTING', name='routingtype'), nullable=True),
        ...
        sa.Column('sms_cost_outbound', sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column('sms_cost_inbound', sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column('voice_cost_per_minute', sa.Numeric(precision=10, scale=4), nullable=True),
        ...
        sa.Column('monthly_cost_incurred', sa.Numeric(precision=10, scale=4), nullable=True),
    ...
    op.create_index('idx_user_number_primary', 'user_numbers', ['user_id', 'is_primary'])
    op.create_index('idx_user_numbers_phone_number', 'user_numbers', ['phone_number'])
    
    # Create enhanced_messages table
    op.create_table('enhanced_messages',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('user_id', sa.String(), nullable=False),
        sa.Column('category', sa.Enum('VERIFICATION_CODE', 'CONVERSATION', 'NOTIFICATION', 'SYSTEM', name='messagecategory'), nullable=False),
        ...
        sa.Column('code_extraction_confidence', sa.Numeric(precision=5, scale=4), nullable=True),
        ...
        sa.ForeignKeyConstraint(['from_number_id'], ['user_numbers.id'], ),
        sa.ForeignKeyConstraint(['to_number_id'], ['user_numbers.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    ...
    op.create_index('idx_enhanced_message_verification', 'enhanced_messages', ['verification_id'])
    op.create_index('idx_enhanced_message_provider_id', 'enhanced_messages', ['provider_message_id'])
    op.create_index('idx_enhanced_message_inbox', 'enhanced_messages', ['user_id', 'category', 'is_read'])
    
    # Create country_routing table
    op.create_table('country_routing',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('country_code', sa.String(length=3), nullable=False),
        sa.Column('country_name', sa.String(length=100), nullable=False),
        sa.Column('continent', sa.String(length=50), nullable=True),
        sa.Column('region', sa.String(length=100), nullable=True),
        sa.Column('tier', sa.Enum('TIER_1', 'TIER_2', 'TIER_3', name='countrytier'), nullable=True),
        sa.Column('dial_code', sa.String(length=10), nullable=False),
        sa.Column('preferred_routing_type', sa.Enum('DIRECT', 'LOCAL_NUMBER', 'REGIONAL_HUB', 'SMART_ROUTING', name='routingtype'), nullable=True),
        ...
        sa.Column('voice_cost_per_minute', sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column('local_number_monthly_cost', sa.Numeric(precision=10, scale=4), nullable=True),
    ...
    op.create_index('idx_country_routing_country_code', 'country_routing', ['country_code'])
    ...
    op.create_table('routing_decisions',
        ...
        sa.Column('routing_type_chosen', sa.Enum('DIRECT', 'LOCAL_NUMBER', 'REGIONAL_HUB', 'SMART_ROUTING', name='routingtype'), nullable=False),
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['message_id'], ['enhanced_messages.id'], ),
        sa.ForeignKeyConstraint(['source_number_id'], ['user_numbers.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index('idx_routing_decision_country', 'routing_decisions', ['destination_country'])
    op.create_index('idx_routing_decision_type', 'routing_decisions', ['routing_type_chosen'])
    ...
    op.create_table('message_folders',
        sa.Column('id', sa.String(), nullable=False),
