...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_session_refresh_token", "sessions", ["refresh_token"], unique=False
    )
    op.create_index(
        "idx_session_user_active", "sessions", ["user_id", "is_active"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_apikey_user_active", "api_keys", ["user_id", "is_active"], unique=False
    )
    ...
    op.create_index(
        "idx_verification_status", "verification_requests", ["status"], unique=False
    )
    op.create_index(
        "idx_verification_textverified_id",
        "verification_requests",
        ["textverified_id"],
        unique=False,
    )
    op.create_index(
        "idx_verification_user", "verification_requests", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_verification_requests_textverified_id"),
        "verification_requests",
        ["textverified_id"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_verification_textverified_id", table_name="verification_requests"
    )
