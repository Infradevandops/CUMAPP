...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "ACTIVE", "ARCHIVED", "DELETED", "BLOCKED", name="conversationstatus"
            ),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_conversation_created_by", "conversations", ["created_by"], unique=False
    )
    op.create_index(
        "idx_conversation_external_number",
        "conversations",
        ["external_number"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_message_conversation", "messages", ["conversation_id"], unique=False
    )
