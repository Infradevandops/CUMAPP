...
def upgrade():
    ...
    op.create_table('verification_services',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('service_name', sa.String(length=100), nullable=False),
        sa.Column('display_name', sa.String(length=200), nullable=False),
        sa.Column('category', sa.Enum('SOCIAL', 'MESSAGING', 'TECH', 'GAMING', 'FINANCE', 'ECOMMERCE', 'OTHER', name='servicecategory'), nullable=False),
        sa.Column('is_active', sa.Boolean(), nullable=True),
        sa.Column('provider', sa.Enum('TEXTVERIFIED', 'TWILIO', 'MOCK', name='verificationprovider'), nullable=True),
    ...
    op.create_index('idx_service_active', 'verification_services', ['is_active'], unique=False)
    op.create_index('idx_service_category', 'verification_services', ['category'], unique=False)
    op.create_index('idx_service_name', 'verification_services', ['service_name'], unique=False)
    op.create_index('idx_service_provider', 'verification_services', ['provider'], unique=False)
    op.create_index(op.f('ix_verification_services_service_name'), 'verification_services', ['service_name'], unique=True)

    # Update verification_requests table with enhanced fields
    op.add_column('verification_requests', sa.Column('service_id', sa.String(), nullable=True))
    op.add_column('verification_requests', sa.Column('provider', sa.Enum('TEXTVERIFIED', 'TWILIO', 'MOCK', name='verificationprovider'), nullable=True))
    op.add_column('verification_requests', sa.Column('provider_request_id', sa.String(length=200), nullable=True))
    op.add_column('verification_requests', sa.Column('country_code', sa.String(length=3), nullable=True))
    op.add_column('verification_requests', sa.Column('routing_info', sa.JSON(), nullable=True))
    op.add_column('verification_requests', sa.Column('cost_estimate', sa.Numeric(precision=10, scale=4), nullable=True))
    op.add_column('verification_requests', sa.Column('actual_cost', sa.Numeric(precision=10, scale=4), nullable=True))
    op.add_column('verification_requests', sa.Column('retry_count', sa.Integer(), nullable=True))
    op.add_column('verification_requests', sa.Column('max_retries', sa.Integer(), nullable=True))
    op.add_column('verification_requests', sa.Column('last_retry_at', sa.DateTime(), nullable=True))
    op.add_column('verification_requests', sa.Column('received_messages', sa.JSON(), nullable=True))
    op.add_column('verification_requests', sa.Column('extracted_codes', sa.JSON(), nullable=True))
    op.add_column('verification_requests', sa.Column('auto_completed', sa.Boolean(), nullable=True))
    op.add_column('verification_requests', sa.Column('priority', sa.String(length=20), nullable=True))
    op.add_column('verification_requests', sa.Column('metadata', sa.JSON(), nullable=True))
    
    # Add foreign key constraint for service_id
    op.create_foreign_key(None, 'verification_requests', 'verification_services', ['service_id'], ['id'])
    
    # Create verification_messages table
    op.create_table('verification_messages',
        sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_index('idx_message_received', 'verification_messages', ['received_at'], unique=False)
    op.create_index('idx_message_verification', 'verification_messages', ['verification_id'], unique=False)

    # Create verification_analytics table
    op.create_table('verification_analytics',
        sa.Column('id', sa.String(), nullable=False),
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['service_id'], ['verification_services.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_analytics_country_date', 'verification_analytics', ['country_code', 'date'], unique=False)
    op.create_index('idx_analytics_date', 'verification_analytics', ['date'], unique=False)
    op.create_index('idx_analytics_service_date', 'verification_analytics', ['service_id', 'date'], unique=False)
    op.create_index('idx_analytics_user_date', 'verification_analytics', ['user_id', 'date'], unique=False)

    # Create subscription_plan_configs table
    op.create_table('subscription_plan_configs',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('plan_name', sa.Enum('FREE', 'BASIC', 'STANDARD', 'PREMIUM', 'ENTERPRISE', name='subscriptionplan'), nullable=False),
        ...
        sa.Column('voice_overage_rate', sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column('verification_overage_rate', sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column('is_active', sa.Boolean(), nullable=True),
    ...
    op.create_index('idx_plan_active', 'subscription_plan_configs', ['is_active'], unique=False)
    op.create_index('idx_plan_name', 'subscription_plan_configs', ['plan_name'], unique=False)
    op.create_index('idx_plan_sort', 'subscription_plan_configs', ['sort_order'], unique=False)
    op.create_index(op.f('ix_subscription_plan_configs_plan_name'), 'subscription_plan_configs', ['plan_name'], unique=True)
    ...
    op.create_table('user_subscriptions',
        ...
        sa.Column('status', sa.Enum('ACTIVE', 'CANCELLED', 'EXPIRED', 'SUSPENDED', 'PENDING', name='subscriptionstatus'), nullable=True),
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['plan_id'], ['subscription_plan_configs.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_subscription_billing_date', 'user_subscriptions', ['next_billing_date'], unique=False)
    op.create_index('idx_subscription_status', 'user_subscriptions', ['status'], unique=False)
    op.create_index('idx_subscription_stripe', 'user_subscriptions', ['stripe_subscription_id'], unique=False)
    op.create_index('idx_subscription_user', 'user_subscriptions', ['user_id'], unique=False)
    ...
    op.create_index('idx_payment_stripe_intent', 'payments', ['stripe_payment_intent_id'], unique=False)
    ...
    op.create_table('usage_records',
        ...
        sa.Column('user_id', sa.String(), nullable=False),
        sa.Column('subscription_id', sa.String(), nullable=True),
        sa.Column('usage_type', sa.Enum('SMS_SENT', 'SMS_RECEIVED', 'VOICE_MINUTES', 'VERIFICATION_REQUEST', 'PHONE_NUMBER_RENTAL', 'API_CALL', name='usagetype'), nullable=False),
    ...
    op.create_index('idx_usage_resource', 'usage_records', ['resource_id'], unique=False)
    op.create_index('idx_usage_subscription_period', 'usage_records', ['subscription_id', 'billing_period_start'], unique=False)
    op.create_index('idx_usage_type_timestamp', 'usage_records', ['usage_type', 'usage_timestamp'], unique=False)
    op.create_index('idx_usage_user_period', 'usage_records', ['user_id', 'billing_period_start'], unique=False)
    ...
    op.create_table('subscription_analytics',
        ...
        sa.Column('date', sa.DateTime(), nullable=False),
        sa.Column('period_type', sa.String(length=20), nullable=True),
        sa.Column('plan_name', sa.Enum('FREE', 'BASIC', 'STANDARD', 'PREMIUM', 'ENTERPRISE', name='subscriptionplan'), nullable=True),
        ...
        sa.Column('average_revenue_per_user', sa.Numeric(precision=10, scale=2), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_sub_analytics_date', 'subscription_analytics', ['date'], unique=False)
    op.create_index('idx_sub_analytics_plan_date', 'subscription_analytics', ['plan_name', 'date'], unique=False)

    # Create communication_sessions table
    op.create_table('communication_sessions',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('user_id', sa.String(), nullable=False),
        sa.Column('session_type', sa.Enum('SMS', 'MMS', 'VOICE', 'CONFERENCE', name='communicationtype'), nullable=False),
    ...
    op.create_index('idx_session_active', 'communication_sessions', ['is_active'], unique=False)
    op.create_index('idx_session_external_number', 'communication_sessions', ['external_number'], unique=False)
    op.create_index('idx_session_last_activity', 'communication_sessions', ['last_activity_at'], unique=False)
    op.create_index('idx_session_type', 'communication_sessions', ['session_type'], unique=False)
    op.create_index('idx_session_user', 'communication_sessions', ['user_id'], unique=False)
    ...
    op.create_table('communication_messages',
        ...
        sa.Column('message_type', sa.Enum('SMS', 'MMS', 'VOICE', 'CONFERENCE', name='communicationtype'), nullable=True),
        sa.Column('content', sa.Text(), nullable=False),
        sa.Column('from_number', sa.String(length=20), nullable=False),
        sa.Column('to_number', sa.String(length=20), nullable=False),
        sa.Column('provider', sa.String(length=50), nullable=True),
        sa.Column('provider_message_id', sa.String(length=200), nullable=True),
        sa.Column('status', sa.Enum('QUEUED', 'SENDING', 'SENT', 'DELIVERED', 'FAILED', 'UNDELIVERED', name='messagestatus'), nullable=True),
        ...
        sa.Column('routing_strategy', sa.Enum('DIRECT', 'SMART_ROUTING', 'COST_OPTIMIZED', 'DELIVERY_OPTIMIZED', name='routingstrategy'), nullable=True),
    ...
    op.create_index('idx_message_created', 'communication_messages', ['created_at'], unique=False)
    op.create_index('idx_message_delivery_status', 'communication_messages', ['status'], unique=False)
    op.create_index('idx_message_direction', 'communication_messages', ['direction'], unique=False)
    op.create_index('idx_message_numbers', 'communication_messages', ['from_number', 'to_number'], unique=False)
    op.create_index('idx_message_provider_id', 'communication_messages', ['provider_message_id'], unique=False)
    op.create_index('idx_message_session', 'communication_messages', ['session_id'], unique=False)
    op.create_index('idx_message_status', 'communication_messages', ['status'], unique=False)
    op.create_index('idx_message_type', 'communication_messages', ['message_type'], unique=False)
    op.create_index('idx_message_user', 'communication_messages', ['user_id'], unique=False)

    # Create conference_calls table
    op.create_table('conference_calls',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('user_id', sa.String(), nullable=False),
    ...
    op.create_index('idx_conference_created', 'conference_calls', ['created_at'], unique=False)
    op.create_index('idx_conference_name', 'conference_calls', ['conference_name'], unique=False)
    op.create_index('idx_conference_provider_id', 'conference_calls', ['provider_conference_id'], unique=False)
    op.create_index('idx_conference_status', 'conference_calls', ['status'], unique=False)
    op.create_index('idx_conference_user', 'conference_calls', ['user_id'], unique=False)
    ...
    op.create_table('voice_calls',
        ...
        sa.Column('status', sa.Enum('QUEUED', 'RINGING', 'IN_PROGRESS', 'COMPLETED', 'BUSY', 'NO_ANSWER', 'FAILED', 'CANCELLED', name='callstatus'), nullable=True),
        ...
        sa.Column('ended_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['conference_id'], ['conference_calls.id'], ),
        sa.ForeignKeyConstraint(['session_id'], ['communication_sessions.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_call_conference', 'voice_calls', ['conference_id'], unique=False)
    ...
    op.create_index('idx_call_provider_id', 'voice_calls', ['provider_call_id'], unique=False)
    ...
    op.create_table('communication_analytics',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('date', sa.DateTime(), nullable=False),
        sa.Column('period_type', sa.String(length=20), nullable=True),
        sa.Column('user_id', sa.String(), nullable=True),
        ...
        sa.Column('total_cost', sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column('average_delivery_time', sa.Integer(), nullable=True),
        sa.Column('delivery_success_rate', sa.Numeric(precision=5, scale=4), nullable=True),
    ...
    op.create_index('idx_comm_analytics_country_date', 'communication_analytics', ['country_code', 'date'], unique=False)
    op.create_index('idx_comm_analytics_date', 'communication_analytics', ['date'], unique=False)
    op.create_index('idx_comm_analytics_number_date', 'communication_analytics', ['phone_number', 'date'], unique=False)
    op.create_index('idx_comm_analytics_user_date', 'communication_analytics', ['user_id', 'date'], unique=False)
    ...
    op.add_column('phone_numbers', sa.Column('usage_plan', sa.String(length=50), nullable=True))
    op.add_column('phone_numbers', sa.Column('webhook_url', sa.String(length=500), nullable=True))
