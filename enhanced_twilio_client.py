...
class EnhancedTwilioClient:
    ...
    # SMS Methods
    async def send_sms(self, from_number: str, to_number: str, message: str, **kwargs) -> Dict[str, Any]:
        """
    ...
    async def receive_sms_webhook(self, webhook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Processed incoming SMS: {processed_data['sid']} from {processed_data['from_number']}")
    ...
    # Voice Call Methods
    async def make_call(self, from_number: str, to_number: str, twiml_url: str = None, **kwargs) -> Dict[str, Any]:
        """
    ...
    async def receive_call_webhook(self, webhook_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(f"Processed incoming call: {processed_data['sid']} from {processed_data['from_number']}")
            return processed_data
    ...
    async def forward_call(self, call_sid: str, forward_to: str, **kwargs) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            call = self.client.calls(call_sid).update(
                url=f"http://twimlets.com/forward?PhoneNumber={forward_to}",
                **kwargs
            )
    ...
    async def create_conference(self, conference_name: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "date_created": conference.date_created.isoformat() if conference.date_created else None,
                "participant_count": 0
            }
    ...
    async def search_available_numbers(self, country_code: str, area_code: str = None, **kwargs) -> List[Dict[str, Any]]:
        """
    ...
    async def purchase_number(self, phone_number: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "status": "purchased",
                "date_created": incoming_phone_number.date_created.isoformat() if incoming_phone_number.date_created else None,
                "capabilities": {
            ...
            logger.info(f"Number purchased successfully: {phone_number} (SID: {incoming_phone_number.sid})")
            return result
...
def create_enhanced_twilio_client(account_sid: str = None, auth_token: str = None) -> Union[EnhancedTwilioClient, None]:
    """
