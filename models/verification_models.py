...
from sqlalchemy import (
    ...
    Enum, Integer, Numeric, Index, JSON
)
...
class VerificationService(Base):
    ...
    provider = Column(Enum(VerificationProvider), default=VerificationProvider.TEXTVERIFIED)
    ...
    # Relationships
    verification_requests = relationship("VerificationRequest", back_populates="service")
...
class VerificationRequest(Base):
    ...
    service = relationship("VerificationService", back_populates="verification_requests")
...
class VerificationExportRequest(BaseModel):
    ...
    format_type: str = Field("json", regex="^(json|csv)$")
