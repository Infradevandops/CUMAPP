...
class CircuitBreaker:
    ...
    def _record_request(self, success: bool, duration: float, exception: Optional[Exception] = None):
    ...
    def _get_failure_rate(self) -> float:
        ...
        with self.lock:
            ...
            failed_requests = sum(1 for req in self.request_history if not req["success"])
    ...
    def _should_open_circuit(self) -> bool:
        ...
        return (
            recent_requests >= self.config.minimum_requests and
...
def textverified_circuit_breaker(func):
    ...
    breaker = circuit_manager.get_breaker("textverified", ServiceCircuitConfigs.textverified())
